...
Error
************************/
	Error::Error(wchar_t* _description) : description(_description)
	{
...
****************************/
	...
	DateTime SystemTimeToDateTime(const SYSTEMTIME& systemTime)
	{
		...
		dateTime.millisecond = systemTime.wMilliseconds;
		...
		dateTime.totalMillisecond = dateTime.filetime / 10000;
